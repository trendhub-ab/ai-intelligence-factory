...
TECH_PROP_NAME = '技術・プロジェクト名'
TECH_PROP_JAPANESE_DISPLAY_LABEL = '日本語表示名'
TECH_PROP_PRIMARY_URL = '公式URL'
TECH_PROP_SOURCE = '情報源'
TECH_PROP_CATEGORY = '分野（内部）'
TECH_PROP_ADOPTION_SCORE = '採用スコア（内部）'
TECH_PROP_ADOPTION_STATUS = '採用判断（内部）'
TECH_PROP_EVIDENCE_CONFIDENCE = '根拠信頼度（内部）'
TECH_PROP_PRODUCTION_READINESS = '実用準備度（内部）'
TECH_PROP_MAIN_RISK = '主リスク（内部）'
TECH_PROP_BEST_FOR = '向いている用途（内部）'
TECH_PROP_AVOID_FOR = '向いていない用途（内部）'
TECH_PROP_SHORT_RATIONALE = '判断理由（内部）'
TECH_PROP_FIRST_SEEN = '初回発見日（内部）'
TECH_PROP_LAST_REVIEWED = '最終レビュー日（内部）'
TECH_PROP_PREVIOUS_SCORE = '前回スコア'
TECH_PROP_SCORE_CHANGE = 'スコア変化'
TECH_PROP_LAST_CHANGE_AT = '最終変化日'
TECH_PROP_RELATED_ARTICLE = '関連記事（内部）'
TECH_PROP_EVIDENCE_URLS = '一次情報URL（内部）'
TECH_PROP_ENTITY_ID = '正規エンティティID'
TECH_PROP_ENTITY_STATUS = 'エンティティ解決状態'
TECH_PROP_ENTITY_ALIASES = 'エンティティ別名'
TECH_PROP_TRACKING_STATUS = '追跡状態'
TECH_PROP_TRACKING_ELIGIBILITY = '追跡対象'
TECH_PROP_TRACKING_REASON = '追跡理由'
TECH_PROP_ASSESSMENT_STATE = '評価状態'
TECH_PROP_LAST_EVIDENCE_UPDATE = '最終根拠更新日'
TECH_PROP_NEXT_REVIEW = '次回レビュー日'
TECH_PROP_PIPELINE_STATUS = 'パイプライン状態'
TECH_PROP_CONTENT_STATUS = 'コンテンツ状態'
TECH_PROP_ARTICLE_STATUS = '記事状態'
TECH_PROP_SCREENING_SCORE = '選別スコア'
TECH_PROP_SCREENING_REASON = '選別理由'
TECH_PROP_SOURCE_SUMMARY = '元情報要約'
TECH_PROP_PUBLISHED_AT = '公開日'
TECH_PROP_ANALYZED_AT = '分析日'

HISTORY_PROP_TITLE = '履歴名'
HISTORY_PROP_TECHNOLOGY = '技術'
HISTORY_PROP_REVIEWED_AT = 'レビュー日'
HISTORY_PROP_ADOPTION_SCORE = '採用スコア'
HISTORY_PROP_ADOPTION_STATUS = '採用判断'
HISTORY_PROP_PRODUCTION_READINESS = '実用準備度'
HISTORY_PROP_EVIDENCE_CONFIDENCE = '根拠信頼度'
HISTORY_PROP_MAIN_RISK = '主なリスク'
HISTORY_PROP_CHANGE_REASON = '変更理由'
HISTORY_PROP_EVIDENCE_ADDED = '追加根拠'
HISTORY_PROP_PREVIOUS_SCORE = '前回スコア'
HISTORY_PROP_SCORE_DELTA = 'スコア差分'
HISTORY_PROP_PREVIOUS_STATUS = '前回採用判断'
HISTORY_PROP_STATUS_CHANGED = '判断変更'
HISTORY_PROP_SNAPSHOT_TYPE = 'スナップショット種別'
HISTORY_PROP_ENTITY_ID = '正規エンティティID'
HISTORY_PROP_EVENT_ID = '履歴イベントID'
...
MONTHLY_PROP_TITLE = '月次ダイジェスト'
MONTHLY_PROP_PERIOD_ID = '対象期間ID'
MONTHLY_PROP_GENERATED_AT = '生成日'
MONTHLY_PROP_CHANGE_COUNT = '変化件数'
MONTHLY_PROP_SUMMARY = '要約'
