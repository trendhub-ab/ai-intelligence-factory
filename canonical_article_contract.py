...
4. 中核メカニズム：Central Conclusion / Capability Boundary / Reader Decisionの理解に必要な仕組みを説明する。技術説明が続くときは、各説明がNarrative QuestionやDecisionを何か一歩進めるか確認する。進めない説明は削り、進める説明は仕組みの後で「だから読者にとって何が変わるか」を普通の日本語へ戻してから次へ進む。必要な複数の仕組みを個数上限で削らない。
