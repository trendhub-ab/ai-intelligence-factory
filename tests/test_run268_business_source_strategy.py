...
class Run268AcquisitionTests(unittest.TestCase):
    ...
    def test_official_vendor_fetch_keeps_vendor_metadata_and_round_robin(self):
        ...
        pages = {
            "https://openai.com/releases": '<h2>2026-09-07 API model release</h2><a href="/release/one">API pricing update</a><a href="/release/two">SDK update</a>',
            "https://deepseek.com/releases": '<h2>2026-09-07 模型发布更新</h2><a href="/release/a">API 价格更新</a><a href="/release/b">模型接口升级</a>',
        }
    ...
    def test_hn_algolia_is_bounded_deduped_and_uses_no_topstories(self):
        calls = []
        ...
        def fake_get(url, **kwargs):
            ...
            return FakeResponse(
                payload={
                    "hits": [
                        {"objectID": "42", "title": "New AI model", "url": "https://example.com/ai", "points": 90, "num_comments": 20, "created_at_i": 1788700000},
