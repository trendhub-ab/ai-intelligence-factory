...
MEMBER_HOME_ID = "3d0479ff-dca9-819e-9da0-c951225de6b3"
...
class Run217MemberCommerceContractTests(unittest.TestCase):
    ...
    def test_functional_and_member_ux_baselines_are_not_relabelled(self):
    ...
    def test_run217_is_separate_commerce_onboarding_baseline(self):
    ...
    def test_canonical_member_home_and_current_db_ids_match_across_docs(self):
        for value in (MEMBER_HOME_ID, CURRENT_DB_ID, CURRENT_DATA_SOURCE_ID):
    ...
    def test_run217_does_not_resume_daily_or_claim_model_generation(self):
        ...
        self.assertIn("does not:\n- call Gemini or any model API", self.run217)
