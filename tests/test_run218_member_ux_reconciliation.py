...
CURRENT_DS_ID = "d1461b6f-0940-4bf9-803a-6686a37c4ba2"
...
class Run218MemberUxReconciliationTests(unittest.TestCase):
    ...
    def test_run218_is_current_navigation_ui_baseline(self):
    ...
    def test_exact_canonical_home_is_locked_across_current_docs(self):
        for text in (self.readme, self.spec, self.run218):
    ...
    def test_customer_hierarchy_and_current_database_are_locked(self):
    ...
    def test_legacy_database_remains_forbidden(self):
        ...
        self.assertIn("旧版・使用禁止", self.run218)
        self.assertIn("旧版・使用禁止", self.readme)
        self.assertIn("旧版・使用禁止", self.spec)

    def test_run218_has_no_model_or_daily_activation_path(self):
