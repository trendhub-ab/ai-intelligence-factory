...
class Run130FreshArticleRegressionReconciliationTests(unittest.TestCase):
    ...
    def test_invalid_article_set_fails_before_any_selector(self):
        with patch.object(pipeline, "REGEN_TEST_ARTICLE_SET", "unexpected"), \
             patch.object(pipeline, "get_fresh_regen_test_items") as fresh, \
             patch.object(pipeline, "get_regen_test_items") as fixed:
